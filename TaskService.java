...
public class TaskService {
    ...
    public static void main(String[] args) {
        ...
        service.addTask(new Task("0000000001", "Reading", "Read a Book"));
        service.addTask(new Task("0000000002", "Playing", "Computer"));
        service.addTask(new Task("0000000003", "Walking", "Walk 1 mile"));
